...
\begin{table}[H]
    \centering
       ...
       \end{tabular}
    \end{table}
\noindent Die Abweichung von den Literaturwerten der vermuteten Metalle liegt im Rahmen der Messungenauigkeit, sodass im Weiteren davon ausgegangen wird,
...
\begin{table}[H]
    \centering
        ...
        \begin{tabular}{S S[table-format=3.2] @{${}\pm{}$} S[table-format=1.2] S[table-format=3.0] S}
          ...
          $\text{Messing}$  & 106.02 & 2.34 & {78-123} & {\num{35.9}-\num{13.8}}\\ %DAS SIEHT SUPER HÄSSLICH AUS!!
          \bottomrule
       \end{tabular}
    \end{table}
