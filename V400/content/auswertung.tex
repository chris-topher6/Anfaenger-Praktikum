...
\end{figure}
\noindent
Die Ablenkung wurde mit \eqref{eqn:ablenkwinkel} mit \textit{numpy}\cite{numpy} ermittelt. Der verwendete Brechungsindex beträgt $n = 1.61282$, siehe Tabelle \ref{tab:brechungsind}.
