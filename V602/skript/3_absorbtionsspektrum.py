...
def fmt_single(name, d):
    return '\n'.join((
        ...
        r'\begin{table}[H]                                                                                   ',
        r'    \centering                                                                                     ',
        r'        \caption{Wertepaare für die Extrema und den berechneten Mittelpunkt.}                      ',
        r'        \label{tab:energie}                                                                        ',
        r'        \sisetup{table-format=3.0}                                                                 ',
        r'        \begin{tabular}{S S[table-format=2.2] S}                                                   ',
        r'          \toprule                                                                                 ',
        r'          {Punkt} & {$\theta [\si{\degree}]$} & {$N$}\\                                            ',
        r'          \midrule                                                                                 ',
        r'          {$I_{K,Min  $} &' + f"{d['θ_bounds'][0].m:.1f}" + '&' + f"{d['I_K_bounds'][0]:.0f}" +   '',                                               
        r'          {$I_{K,Max  $} &' + f"{d['θ_bounds'][1].m:.1f}" + '&' + f"{d['I_K_bounds'][1]:.0f}" +   '',                                               
        r'          {$I_{K,Mitte$} &' + f"{d['θ_middle'].m:.2f}"    + '&' + f"{d['I_K']:.1f}"           +   '',                                               
        r'          \bottomrule                                                                              ',
        r'        \end{tabular}                                                                              ',
        r'      \end{table}                                                                                  ',
        r'Daraus ergibt sich                                                                                 ',
        r'\begin{align*}                                                                                     ',
        r'    E_\text{' + name + r'} &= \SI{' + f"{d['E'].m:.2f}" + r'}{\kilo\electronvolt}                  ',
        r'    \sigma_{K, \text{' + name + r'}} &= \num{' + f"{d['sigma_K'].m:.2f}" + '}                      ',
        r'\end{align*}                                                                                       ',
        ))
