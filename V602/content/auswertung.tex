...
%Die totale Abweichung zu dem Theoriewert beträgt somit $\Delta\theta_{glanz}=\SI{0.2}{\degree}$,
%was nach
%\begin{equation*}
%    p=\frac{\theta_{ideal}-\theta_{mess}}{\theta_{ideal}}\cdot \num{100}
%\end{equation*}
%einer prozentualen Abweichung von $p=\SI{0.71}{\percent}$ entspricht.
\begin{figure}[H]
    \centering
