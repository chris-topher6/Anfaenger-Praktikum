...
print("Aufgabe a")
plt.figure()
plt.plot(Ua, I1, 'r.', label='I=2.1 A')
plt.plot(Ua, I2, 'g.', label='I=2.2 A')
plt.plot(Ua, I3, 'c.', label='I=2.3 A')
plt.plot(Ua, I4, 'b.', label='I=2.4 A')
plt.plot(Ua, I5, 'y.', label='I=2.5 A')
