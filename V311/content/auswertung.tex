\section{Auswertung}
  ...
  konstantem Spuhlenstrom.
    ...
    \label{sec:mitflugz}
      ...
      $e_{0}$ die Elementarladung, $R = 0.6 \si{\ohm}$ der gemessene Widerstand, $n$ die Anzahl der Ladungsträger pro Volumen wie in \ref{sec:adtrprovol} berechnet
    ...
    \label{sec:totgeschw}
      ...
      \begin{equation}
        E_{F} = \frac{h^{2}}{2m_{0}} \cdot \sqrt[3]{(\frac{3n}{8 \pi})^{2}}
      \end{equation}
