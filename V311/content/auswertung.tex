\section{Auswertung}
  ...
  Python Datenbank verwendet sowie für Unsicherheiten Numeric Python.
    ...
    \label{sec:mitflugz}
      ...
      zu
      \begin{align*}
        \bar{\tau}_{P} & = (3.4 \pm 2.3) \cdot 10^{-13} \si{\second} \\
        \bar{\tau}_{S} & = (1.9 \pm 1.7) \cdot 10^{-13} \si{\second}. 
      \end{align*}
    ...
    \subsubsection{Die mittlere Driftgeschwindigkeit}
      ...
      Dann ergibt sich
      \begin{align*}
        \bar{v_{dP}} & = (7 \pm 4) \cdot 10^{-7} \si{\meter\per\second} \\
        \bar{v_{dS}} & = (3.6 \pm 3.2) \cdot 10^{-7} \si{\meter\per\second}
      \end{align*}
