...
print(f'a30s={params30s0}')
print(f'b30s={params30s1}')
print(f'a45s={params45s0}')
print(f'b45s={params45s1}')
print(f'a15m={params15m0}') #m
print(f'b15m={params15m1}')
print(f'a30m={params30m0}')
print(f'b30m={params30m1}')
print(f'a45m={params45m0}')
print(f'b45m={params45m1}')
print(f'a15l={params15l0}') #l
print(f'b15l={params15l1}')
print(f'a30l={params30l0}')
print(f'b30l={params30l1}')
print(f'a45l={params45l0}')
print(f'b45l={params45l1}')
