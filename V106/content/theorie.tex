...
\begin{enumerate}
    ...
    \item Gegensinnige Schwingung: $\alpha_1=-\alpha_2$
        ...
        \begin{equation}
            \omega_{-}=\sqrt{\frac{g}{l}+2\frac{kl^2}{mL^2}}. %nochmal überprüfen
        \end{equation}
        ...
        Pendel um $\pi$ phasenverschoden, an ansonsten sind sie aber komplett identisch.  
        \begin{figure}
            \centering
    ...
    \item Gekoppelte Schwingung: $\alpha_1=0$, $\alpha_2\neq 0$
        Bei einer gekoppelten Schwingung wird nur eines der beiden Pendel ausgelekt. Das andere Pendel bleibt in der Ruhelage. Nun kommt es zu dem Phänomen der
        ...
        Pendels bis zum nächsten Stillstand des selben Pendels. Die Schwebungsfrequnzist dabei gegeben durch
        \begin{equation}
        ...
        des Pendels selbst wir durch die dadrunter liegende Sinusfunktion beschrieben.
            ...
            \label{fig:gekoppelt}
        \end{figure}
    Um die Schingungs %% hier den bums mit der Kopplungskonstante ergänzen
\end{enumerate}