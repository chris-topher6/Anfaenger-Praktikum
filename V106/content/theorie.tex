...
Die Schwingungsdauer $T$ des Pendles kann nun aus der Frequenz $\omega$ berechnet werden
\begin{equation}
    T=\frac{2\pi}{\omega}.
\end{equation}
...
\\
Man erhält nun ein Systemaus zwei Differentialgleichungen, die zudem mit einander gekoppelt sind:
\begin{align}
...
\begin{enumerate}
    ...
    \item \textit{Gegensinnige Schwingung: $\alpha_1=-\alpha_2$}\\
        ...
        Pendel um $\pi$ phasenverschoden. Ansonsten sind sie aber komplett identisch.  
        \begin{figure}
            \centering
    ...
    \item \textit{Gekoppelte Schwingung: $\alpha_1=0$, $\alpha_2\neq 0$}\\
        ...
        \begin{figure}
            \centering
            \includegraphics[scale = 0.5]{gekoppelt.pdf}
